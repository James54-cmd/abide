...
import VerseCard from "@/features/verses/components/VerseCard";
import { cn } from "@/lib/utils";
import { useVersesState } from "@/features/verses/hooks/useVersesState";

export default function VersesPage() {
  const { query, activeTopic, results, topics, handleTopicClick, handleQueryChange } =
    useVersesState();
